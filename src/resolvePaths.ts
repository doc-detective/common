...
export interface ResolvePathsOptions {
  config: { relativePathBase: RelativePathBase };
...
export async function resolvePaths({
  ...
  nested = false,
  objectType,
}: ResolvePathsOptions): Promise<Record<string, any>> {
   ...
   */
  function resolve(baseType: RelativePathBase, relativePath: string, filePath: string): string {

module.exports = {
  ...
  rules: {
    ...
    // Properties and type validation rules
    ...
    'schema-type-is-string': {
      description: 'type must be a string or array',
      message: 'The type field must be a string or array of strings',
      given: '$..*[?(@.type)]',
      severity: 'error',
      recommended: true,
      then: {
